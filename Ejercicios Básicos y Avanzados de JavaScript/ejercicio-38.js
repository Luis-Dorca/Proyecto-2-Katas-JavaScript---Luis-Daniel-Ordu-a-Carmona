...
for (const element of users) {
  for (const key in element.favoritesSounds) {
    volumenTotal+=element.favoritesSounds[key].volume;
    sonidoTotal++;
  }
}

const mediaVolumen = volumenTotal / sonidoTotal;

console.log(`El volumen medio de los usuarios es: ${mediaVolumen}`);